...
include(${CMAKE_CURRENT_LIST_DIR}/REY_FetchV4_X.fpng.cmake)

if(  (DEFINED REY_FetchV4_MODS_PATH)   AND   (NOT "${REY_FetchV4_MODS_PATH}" STREQUAL ""))
    if (EXISTS  ${REY_FetchV4_MODS_PATH}/REY_FetchV4_MOD.fpng.cmake)
        include(${REY_FetchV4_MODS_PATH}/REY_FetchV4_MOD.fpng.cmake)
    endif()
endif()
